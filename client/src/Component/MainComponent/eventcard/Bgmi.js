      ...
      <div className="row row-cols-1 row-cols-md-3 py-3 px-3 text-light">
        <div className="col">
          <div className="card1 h-100 w-80 ">
            <img
              src="https://ik.imagekit.io/oyprice/bytes/wp-content/uploads/2021/05/Untitled-design-67-1024x576.png"
              className="card-img-top"
              alt="..."
              loading="lazy"
            />
            <div className="card-body">
              <h5 className="card-title text-warning">B G M I</h5>
              <br />
              ...
              <a
                href="https://youtu.be/w91k6FFy6fc"
                target="_blank"
