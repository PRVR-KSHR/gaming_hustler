      ...
      <div className="body5">
        <section id="home">
          <div className="container-fluid px-0 top-banner2 mb-5">
            <div className='ai4'>
              <lottie-player src="https://assets8.lottiefiles.com/packages/lf20_Uji4LKowtE.json" background="transparent" speed={1} style={{width: '200px', height: '200px'}} loop autoPlay />
            </div>
            <h1 className="b2">PLAY NOW <SiApplearcade /></h1>
            <div id="Games"></div>
          </div>
        </section>
      </div>
      ...
      <div className="container">
        ...
        <li>
            <div className="card">
              ...
              <img className="image" src="img/bgm1.jpg" />
              </div>
              <div className="meta-sission">
                <div className="head">
                  <a href="#" className="catogry">27 DEC 2022 11:00 AM</a>
                ...
                <div className="head1">
                <p style={{color:'#D96009'}}> <BsFillAwardFill /> 100</p>
                <p style={{color:'#D96009'}}> <SiApplearcade /> Duo</p>
                <p style={{color:'#D96009'}}><HiUserGroup /> 24/100</p>
                </div>
                <div className="footer">
                  <a href="https://esportsweb.in/register/RmrjPkeAyuNzys7c4wki" target="_blank" className="button">JOIN NOW</a>
                  <a href="img/results.pdf" 
                  target="_blank" className="button4">Results</a>
                </div>
              </div>
            </div>
          </li>
          <li>
            <div className="card">
              <div className="image-session">
                <img className="image" src="img/coc1.jpg" />
              </div>
              <div className="meta-sission">
                <div className="head">
                  <a href="#" className="catogry">26 Nov 2022 07:00 PM</a>
                  <span className="flexone" />
                  <span className="per">                            
                  </span></div>
                <div className="body">
                ...
                <div className=" head1">
                  <p style={{color:'#D96009'}}> <BsFillAwardFill /> 82</p>
                  <p style={{color:'#D96009'}}> <SiApplearcade /> WAR</p>
                  <p style={{color:'#D96009'}}><HiUserGroup /> 5 vs 5</p>
                </div>
                <div className="footer">
                  <a href="https://esportsweb.in/register/RmrjPkeAyuNzys7c4wki" target="_blank" className="button">JOIN NOW</a>
                  <a href="#" className="button4">Results</a>
                </div>
              </div>
            </div>
          </li>
          <li>
            <div className="card">
              <div className="image-session">
              <img className="image" src="img/cod.png" />
              </div>
              <div className="meta-sission">
                <div className="head">
                  <a href="#" className="catogry">03 DEC 2022 07:00 PM</a>
                  <span className="flexone" />
                  <span className="per">                            
                  </span></div>
                <div className="body">
                ...
                <div className="head1">
                <p style={{color:'#D96009'}}> <BsFillAwardFill /> 72</p>
                <p style={{color:'#D96009'}}> <SiApplearcade /> SQUAD</p>
                <p style={{color:'#D96009'}}><HiUserGroup /> 40/100</p>
                </div>
                <div className="footer">
                  <a href="https://esportsweb.in/register/RmrjPkeAyuNzys7c4wki" target="_blank" className="button">JOIN NOW</a>
                  <a href="#" className="button4">Results</a>
            ...
            <div className="card">
              <div className="image-session">
              <img className="image" src="img/clash.jpg" />
              </div>
              <div className="meta-sission">
                <div className="head">
                  <a href="#" className="catogry">10 DEC 2022 07:00 PM</a>
                  <span className="flexone" />
                  <span className="per">                            
                  </span></div>
                <div className="body">
                ...
                <div className="head1">
                <p style={{color:'#D96009'}}> <BsFillAwardFill />10</p>
                <p style={{color:'#D96009'}}> <SiApplearcade />4V4</p>
                <p style={{color:'#D96009'}}><HiUserGroup />1V1</p>
                </div>
                <div className="footer">
                  <a href="https://esportsweb.in/register/RmrjPkeAyuNzys7c4wki" target="_blank" className="button">JOIN NOW</a>
                  <a href="#" className="button4">Results</a>
          ...
          <li>
            <div className="card">
              <div className="image-session">
              <img className="image" src="img/free.webp" />
              </div>
              <div className="meta-sission">
                <div className="head">
                  <a href="#" className="catogry">04 DEC 2022 11:00 AM</a>
                  <span className="flexone" />
                  <span className="per">                            
                  </span></div>
                <div className="body">
                ...
                <div className="head1">
                <p style={{color:'#D96009'}}> <BsFillAwardFill />35</p>
                <p style={{color:'#D96009'}}> <SiApplearcade />SQUAD</p>
                <p style={{color:'#D96009'}}><HiUserGroup />60/100</p>
                </div>
                <div className="footer">
                  <a href="https://esportsweb.in/register/RmrjPkeAyuNzys7c4wki" target="_blank" className="button">JOIN NOW</a>
                  <a href="#" className="button4">Results</a>
            ...
            <div className="card">
              <div className="image-session">
              <img className="image" src="img/wcc3.avif" />
              </div>
              <div className="meta-sission">
                <div className="head">
                  <a href="#" className="catogry">11 DEC 2022 01:00 PM</a>
                  <span className="flexone" />
                  <span className="per">                            
                  </span></div>
                <div className="body">
                ...
                <div className="head1">
                <p style={{color:'#D96009'}}> <BsFillAwardFill />55</p>
                <p style={{color:'#D96009'}}> <SiApplearcade />1v1</p>
                <p style={{color:'#D96009'}}><HiUserGroup />6v6</p>
                </div>
                <div className="footer">
                  <a href="https://esportsweb.in/register/RmrjPkeAyuNzys7c4wki" target="_blank" className="button">JOIN NOW</a>
                  <div id="Feedback"></div>
...
<section>
        <div className="fed mt-5" >
          <div className="wp">
            ...
            <form className="f1" action="https://formspree.io/f/xwkzyoae" method="POST">
            <div className="dbl-field">
              ...
              <div className="field">
                <input type="number" name="phone" placeholder="Enter your phone" autoComplete="off" required />
